...
/** Rook class, ValidMoves given by chess Rook on keypad.
...
public class Rook extends Piece {
	...
	/** Create Rook piece, filling HashMap with valid moves.
	 * 
	 */
	public Rook() {
		ValidMoves.put(0, new Integer[] {0,2,5,8});
		ValidMoves.put(1, new Integer[] {1,2,3,4,7});
		ValidMoves.put(2, new Integer[] {2,1,3,5,8,0});
		ValidMoves.put(3, new Integer[] {3,1,2,6,9});
		ValidMoves.put(4, new Integer[] {4,1,7,5,6});
		ValidMoves.put(5, new Integer[] {5,2,4,6,8,0});
		ValidMoves.put(6, new Integer[] {6,4,5,3,9});
		ValidMoves.put(7, new Integer[] {7,1,4,8,9});
		ValidMoves.put(8, new Integer[] {8,0,2,5,7,9});
		ValidMoves.put(9, new Integer[] {9,7,8,3,6});
	}
